...
import 'package:DNL/view/components/CustomButton.dart';
import 'package:DNL/view/main/widgets/bottom_navigation_bar.dart';
import 'package:DNL/view/messageFlow/Chat.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          Container(
            padding: const EdgeInsets.only(top: 66,bottom: 33,left: 33,right: 33),
            child: const Column(
              children: [
                Text(
                  "Messages",
                  ...
                  if (messageList.isNotEmpty)
                    Column(
                      children: [
                        ...
                        MaterialPageRoute(builder: (context) => ChatScreen(message.receiver.name)
